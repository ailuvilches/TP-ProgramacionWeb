...
productos.forEach((item) => {
    ...
    <a class="imagenProductoCamisetas" href="producto.html"><img class="imagenProductoCamisetas" src="${item.imagen}" alt=""></a>
        ...
        <div class="formularioParaSlider">
            <form action="">
            <input class="input-cantidadCamisetas" type="number" name="cantidad" value="1" min="1" max="10" step="" id="botonCantidad">
            </form>
	...
	let botonAgregarCamisetas = contenido.querySelector(
		".boton-agregarCamisetas"
	);
	botonAgregarCamisetas.addEventListener("click", (e) => {

      

        let valor = e.path[1].getElementsByTagName('form')[0].querySelector("#botonCantidad").value * 1;
